    ...
    <div>
        <div class='container'>
            ...
            >
                ...
                <el-table-column prop='courseAmount' label='课时数'></el-table-column>
                ...
                <el-table-column label='状态' align='center'>
                    <template slot-scope='scope'>
                        ...
                        >{{ scope.row.status === 1? '上架':(scope.row.status === 0? '下架': '') }}
                        </el-tag>
                    </template>
                </el-table-column>
...
<script>
import { fetchData, getCoursePage } from '../../api/index';
...
export default {
    ...
    methods: {
        getData() {
            getCoursePage(this.query).then(res => {
                console.log(res);
                if (res.status === 200) {
